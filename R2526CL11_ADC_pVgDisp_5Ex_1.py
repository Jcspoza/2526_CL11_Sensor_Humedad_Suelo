...
# 5Ex_1 -> si tecla back raise Exception
...
p_project = "Potenciometer ADC0 -> display & writer + orden display / teclas BACk sale x Excepcion"
p_version = "5Ex.1"
...
# creo la nueva excepcion
class BackPulsado(Exception):
    pass
...
try:
    ...
    alimentaSensor.off()
    print("Parada de usuario por teclado PC")
    display.fill_rect(0, StatLy, WIDTH, 8, 0)
    display.text('Parada x teclaPC', 0, StatLy, 1)
    display.show()
